...
export interface NeutronLockdropSchema {
  ...
  execute:
    | IncreaseLockupForArgs
    | UpdateConfigArgs
    | SetTokenInfoArgs
    | WithdrawFromLockupArgs
...
export class Client {
  ...
  increaseLockupFor = async(sender:string, args: IncreaseLockupForArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
  ...
  increaseNtrnIncentives = async(sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
  ...
  withdrawFromLockup = async(sender:string, args: WithdrawFromLockupArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
