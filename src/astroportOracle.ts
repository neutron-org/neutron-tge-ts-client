...
export class Client {
  ...
  queryConsult = async(args: ConsultArgs): Promise<ArrayOfTupleOf_AssetInfoAnd_Uint256> => {
    return this.client.queryContractSmart(this.contractAddress, { consult: args });
  }
  queryTWAPAtHeight = async(args: TWAPAtHeightArgs): Promise<ArrayOfTupleOf_AssetInfoAnd_Decimal256> => {
    return this.client.queryContractSmart(this.contractAddress, { t_w_a_p_at_height: args });
  }
  queryConfig = async(): Promise<Config> => {
    return this.client.queryContractSmart(this.contractAddress, { config: {} });
  }
  queryLastUpdateTimestamp = async(): Promise<Uint64> => {
